    ...
    return (
      <Centered>
        <div className="instructions">
          ...
          You and your partner will play two rounds of the game. Every round is preceded by a brief introduction to the rule and is followed by an <font color = "red"> attention check</font>, in which you’ll be asked to identify an object that appeared in the round.
